...
<script runat="server">
    ...
    public static void RegisterRoutes(System.Web.Routing.RouteCollection routes)
    {
        ...
        routes.MapPageRoute("AdminPanelRegistor",
                        "AdminPanel/Registor/Registor",
                        "~/AdminPanel/Registor/Registor.aspx");
        routes.MapPageRoute("AdminPanelLogin",
                        "AdminPanel/Login/Login",
                        "~/AdminPanel/Login/Login.aspx");
        
        //routes.MapPageRoute("AdminPanelLogin", "AdminPanel/Login", "~/AdminPanel/Login.aspx");
        //routes.MapPageRoute("AdminPanelRegisterNewUser", "AdminPanel/RegisterNewUser", "~/AdminPanel/RegisterNewUser.aspx");
        routes.MapPageRoute("AdminPanelDefault", "AdminPanel/Default", "~/AdminPanel/Default.aspx");
    }
